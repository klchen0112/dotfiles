...
* Init.el
:PROPERTIES:
:ID:       75b80b6e-8eec-4e64-be42-3a25f97ae5db
:END:
...
** font
*** for brew users
I use [[https://github.com/shaunsingh/SFMono-Nerd-Font-Ligaturized][SFMono]] font with nerd font and ligatures
...
(cond
 (IS-MAC
  (setq doom-font (font-spec :family "SF Mono"   :size 19)
        ...
        doom-variable-pitch-font (font-spec :family "IBM Plex Serif"  :size 19)
  ...
  (add-hook! 'after-init-hook
            ...
            (lambda ()
              ...
              (set-fontset-font "fontset-default" 'kana     (font-spec :family "PingFang SC"))
              (set-fontset-font "fontset-default" 'hangul   (font-spec :family "PingFang SC"))
...
(if IS-MAC
   ...
   (setq doom-theme (intern (random-choice doom-themes-light)))
)
...
#+begin_src emacs-lisp :tangle config.el
;; below code from https://github.com/VitalyAnkh/config/blob/master/doom/config.org
...
See `org-capture-templates' for more information."
  ...
  (setq org-capture-templates '(("t" "Personal todo" entry
                                 (file+headline "pages/TODO.org" "Inbox")
                                 "* [ ] %?\n%i\n%a" :prepend t)
                                ...
                                ("h"                ;`org-capture' binding + h
                                 ...
                                 (file+headline "~/org/blog/all-blog.org" "Blog Ideas")
                                 (function org-hugo-new-subtree-post-capture-template))
                                ("i" "Some ideas" entry
                                 (file "pages/ideas.org")
                                 "* TODO %?\n" :prepend t)))
  )
#+end_src
** org hugo
...
(use-package! org-roam
  ...
  (setq org-roam-dailies-directory (expand-file-name "journals" org-roam-directory))
  ...
  (setq org-roam-dailies-capture-templates
        '(
          ...
          ("r" "read" entry "*** %?"
           :if-new (file+head+olp "%<%Y-%m-%d>.org" "#+title: %<%Y/%m/%d>\n#+filetags: :journal:\n" ("%<%H:%M:%S>" "What I read? :read:")))
          ("t" "tasks" entry "*** %?"
           :if-new (file+head+olp "%<%Y-%m-%d>.org" "#+title: %<%Y/%m/%d>\n#+filetags: :journal:\n" ("%<%H:%M:%S>" "TODO Tasks :task:")))
          ("n" "notes" entry "*** %?"
           :if-new (file+head+olp "%<%Y-%m-%d>.org" "#+title: %<%Y/%m/%d>\n#+filetags: :journal:\n" ("%<%M:%M:%S>" "Notes :note:")))
          ))
...
** Company
*** packages
#+begin_src emacs-lisp conf :tangle no
;; (package! company-fuzzy)
#+end_src

*** company lib
为company mode 添加数字选择候选的功能
#+begin_src emacs-lisp conf :tangle no
(require 'company)
...
(use-package! conda
  ...
  (if IS-MAC (setq conda-anaconda-home (expand-file-name "/opt/homebrew/Caskroom/miniconda/base")))
...
(use-package! wakatime-mode
  ...
  (setq wakatime-cli-path
        (cond
         (IS-MAC "/opt/homebrew/bin/wakatime-cli")
         (IS-WINDOWS "~/.wakatime/wakatime-cli")
        ))

  (setq wakatime-api-key "e84a8cdb-576e-4f1b-a801-134822c60ea2")
