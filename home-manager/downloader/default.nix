...
{pkgs, ...}: {
  ...
  programs.aria2 = {
    ...
    settings = {
      ...
      #rpc-certificate=/Users/chenkailong/.config/aria2/xxx.pem

      # 在 RPC 服务中启用 SSL/TLS 加密时的私钥文件(.key)
      #rpc-private-key=/Users/chenkailong/.config/aria2/xxx.key
