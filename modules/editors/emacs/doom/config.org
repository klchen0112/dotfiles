...
(use-package! rime
  :config
  (setq rime-librime-root (expand-file-name "librime" doom-user-dir))
  (setq rime-show-candidate 'posframe)
  (setq rime-show-preedit 'inline)
  (setq rime-user-data-dir (expand-file-name "Rime" doom-user-dir))
   ...
   (if IS-MAC
       (concat
        (car (last
         ...
         "/include")
     (concat (shell-command-to-string "nix eval --raw ~/myOpenSource/dotfiles#emacs-unstable") "/include")
     )
  )
