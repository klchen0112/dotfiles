...
let
  ...
  cfg = config.services.sketchybar-bottom;
...

{
  ...
  options.services.sketchybar-bottom = {
    enable = mkEnableOption (mdDoc "sketchybar-bottom");
  ...
  config = mkIf cfg.enable {
    ...
    launchd.user.agents.sketchybar-bottom = {
